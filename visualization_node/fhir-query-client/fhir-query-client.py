...
@app.route('/')
def index():
    """Displays the main page for raw FHIR resource fetching."""
    return render_template('index.html')

@app.route('/fetch_resource', methods=['POST'])
def fetch_resource():
    """Endpoint to fetch FHIR resources based on type."""
...
def visualization():
    """Displays observation trend for a patient."""
    image_data = None
    error = None
    ...
    return render_template("visualization.html", observation_codes=observation_codes, image_data=image_data, error=error, patient_id=patient_id, observation_code=observation_code)
